...
import org.longbow.jgrapetree.test.cases.io.MultiThreadHtmlBuildCase;

public class TestMultiThreadHtmlBuild {
	public static Test suite() {
        TestSuite suite = new TestSuite("MultiThreadHtmlBuild test");
        suite.addTestSuite(MultiThreadHtmlBuildCase.class);
        return suite;
    } 
